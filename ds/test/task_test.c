...
static int TestTaskCreate(void)
{
	...
	/* Test basic creation */
	task1 = TaskCreate(curr_time, DummyJob, NULL, DummyCleanup, NULL, 0);
	...
	/* Test UID uniqueness */
	task2 = TaskCreate(curr_time, DummyJob, NULL, DummyCleanup, NULL, 0);
...
static int TestTaskTime(void)
{
	...
	task = TaskCreate(curr_time, DummyJob, NULL, DummyCleanup, NULL, 0);
...
static int TestTaskRun(void)
{
	...
	/* Test periodic task */
	g_job_counter = 0;
	task = TaskCreate(curr_time, PeriodicJob, NULL, DummyCleanup, NULL, 0);
